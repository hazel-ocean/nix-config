    ...
    SessionStart = [
      {
        hooks = [
          {
            type = "command";
            command = "/Users/hazel/.claude/hooks/capture";
          }
        ];
      }
    ];
    ...
    SessionEnd = [
      {
        hooks = [
          {
            type = "command";
            command = "/Users/hazel/.claude/hooks/cleanup";
          }
        ];
      }
    ];
    Notification = [
      {
        hooks = [
          {
            type = "command";
            command = "/Users/hazel/.claude/hooks/notify";
          }
        ];
      }
    ];
...
in
{
  ...
  permissions = {
    allow = [
      ...
      "mcp__plugin_claude-code-home-manager_github__list_issue_fields"
      ...
      "mcp__plugin_claude-code-home-manager_github__list_repository_collaborators"
      ...
      "mcp__plugin_claude-code-home-manager_github__search_commits"
      ...
      "mcp__plugin_claude-code-home-manager_onesignal-repos__check_remote_access"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__file_exists"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__get_repo_path"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__list_all_repos"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__list_files"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__list_repos"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__read_file"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__read_knowledge"
      "mcp__plugin_claude-code-home-manager_onesignal-repos__search_files"
      "Bash(gh pr view:*)"
      "Bash(gh pr list:*)"
      "Bash(gh pr diff:*)"
      "Bash(gh pr checks:*)"
